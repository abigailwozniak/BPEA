...
keep if lfs0=="I" | lfs0=="U"
gen starE=(lfs2=="IE" | lfs2=="UE")
...
keep age sex edgroup margroup starE wgt year month

compress
save mcr/scratch-m1cls01/data/cps/starE-decomp-`x'.dta, replace
}
...
gen n=wgt
collapse (mean) starE (rawsum) n [aw=wgt], by (year month age sex edgroup margroup)
...
svmat starE
rename starE1 year
rename starE2 yearFE
rename starE3 and_agesex
rename starE4 and_mar
rename starE5 and_ed

save research/brookings-dynamism/output/pub/starE-decomp.dta, replace
