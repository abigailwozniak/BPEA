...
***Creates NE rates using matched CPS data 
...
keep age sex edgroup margroup NE wgt year month

compress
save mcr/scratch-m1cls01/data/cps/NE-decomp-`x'.dta, replace
}
...
gen n=wgt
collapse (mean) NE (rawsum) n [aw=wgt], by (year month age sex edgroup margroup)
...
rename NE1 year
rename NE2 yearFE
rename NE3 and_agesex
rename NE4 and_mar
rename NE5 and_ed

save research/brookings-dynamism/output/pub/NE-decomp.dta, replace
